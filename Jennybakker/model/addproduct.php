...
$sql = "INSERT INTO products (title,content,amount,category,price,size,images,img)
VALUES ('$title','$content','$amount','$category','$price','$size', '$photos','$newfilename')";
$result = $mysqli->query($sql);

header("Location: ../index.php?page=admin&action=producten#new");
?>